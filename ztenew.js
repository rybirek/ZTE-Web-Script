...
onclick="lte_band_selection('1+3+7+20')">B1+B3+B7+B20</a> |
                    <a 
onclick="lte_band_selection('1+3+7+20+38')">B1+B3+B7+B20+B38</a> |
                    <a 
onclick="lte_band_selection('1+3+7+8+20+38')">B1+B3+B7+B8+B20+B38</a> |
                    <a 
onclick="lte_band_selection('1+3+7+8+20')">B1+B3+B7+B8+B20</a> |
                    <a 
onclick="lte_band_selection('1+3+7+8')">B1+B3+B7+B8</a> |
                ]
            ...
            [
                ...
                <a onclick="nr_band_selection('75')">N75</a> |
